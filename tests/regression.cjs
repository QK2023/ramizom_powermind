...
async function run() {
  ...
  assert(html.includes('rel="manifest" href="manifest.webmanifest?v=17"'), 'Page declares its versioned PWA manifest');
  ...
  assert(html.includes('rel="apple-touch-icon" href="apple-touch-icon.png?v=17"'), 'Page declares a versioned Apple touch icon');
  ...
  assert(html.includes('manifest.webmanifest?v=17') && html.includes('style.css?v=17') && html.includes('app.js?v=17'), 'Updated app resources receive a cache version');
